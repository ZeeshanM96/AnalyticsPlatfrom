...
import { fetchUserPreferencesAndRender,
  applyPreferences} from "/static/js/preferences.js";

import {
  getToken, getUser, isAuthenticated, scheduleAutoLogout,
  clearAuth, logState, setUser , setToken
} from "/static/js/auth.js";

import { fetchServiceMetricsData, fetchSourceMetricChartData,
  fetchAlertChartData, fetchResolutionChartData, 
  loadDashboardStats,fetchEventSummary } from "/static/js/chartDataLoaders.js";

import { loadAlertFilterOptions, loadResolutionFilters,
  loadServiceAndMetricOptions, loadMetricTypes, loadSourceTypes } 
...
document.getElementById("setPreferencesBtn").addEventListener("click", async () => {
...
// Event listener
document.getElementById("filterBtn").addEventListener("click", fetchEventSummary);
document.getElementById("metricSearchBtn").addEventListener("click", fetchServiceMetricsData);
document.getElementById("sourceMetricSearchBtn").addEventListener("click", fetchSourceMetricChartData);
document.getElementById("alertFilterBtn").addEventListener("click", fetchAlertChartData);
document.getElementById("issueResolutionBtn").addEventListener("click", fetchResolutionChartData);
